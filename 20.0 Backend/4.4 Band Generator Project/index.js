...
app.post("/submit", (req, res) => {
  ...
  const selectedAdj = Math.floor(Math.random() * adjLength);
  const selectedNoun = Math.floor(Math.random() * nounLength);
  
  const selectedBandName = `${adj[selectedAdj]} ${noun[selectedNoun]}`;
