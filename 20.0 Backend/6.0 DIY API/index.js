...
//The solution.js also shows alternative approaches to achieving the below.
...
app.get("/jokes/:id", (req, res) => {
  //See the better approach in solution.js
...
app.post("/jokes", (req, res) => {
  ...
  jokes.push({id: lastID + 1, jokeText: jokeText,  jokeType:jokeType });
