...
```
dfx identity get-principal => sfz6a-n45nk-ntaie-rpwz4-xczrn-zblee-wkci6-2njcy-m36le-kdgrl-xae
...
Use principal returned when the above command is executed. E.g.,
